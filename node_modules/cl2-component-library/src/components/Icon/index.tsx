...
export const icons = {
  ...
  copy: (props: Props) => (
    <Svg {...props} viewBox="0 0 19 22">
      <path d="M-2-1h24v24H-2z" fill="none" />
      <path d="M14 0H2a2 2 0 00-2 2v14h2V2h12zm3 4H6a2 2 0 00-2 2v14c0 1.1.9 2 2 2h11a2 2 0 002-2V6a2 2 0 00-2-2zm0 16H6V6h11z" />
    </Svg>
  ),
  upload: (props: Props) => (
  ...
  'arrow-back': (props: Props) => (
    <MirrorOnRtlSvg {...props} viewBox="0 0 24 24">
  ...
  'plus-circle': (props: Props) => (
    <Svg {...props} viewBox="2 2 20 20">
      <path fill="none" d="M0 0h24v24H0V0z" />
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11h-4v4h-2v-4H7v-2h4V7h2v4h4v2z" />
    </Svg>
  ),
  'minus-circle': (props: Props) => (
  ...
  'cancel-edit': (props: Props) => (
    <Svg {...props} viewBox="0 0 19 18">
      <path d="M-2-3h24v24H-2zm0 0h24v24H-2z" fill="none" />
      <path d="M10.1 5.1l2-2L15.8 7l-2 2zm8.6-2.5L16.4.3a1 1 0 00-1.4 0L13 2 17 6 18.7 4a1 1 0 000-1.4zM0 2l6.6 6.6L1 14.3V18h3.8l5.6-5.6L16 18l2-2L2 0z" />
    </Svg>
  ),
  upvote: (props: Props) => (
  ...
  idea: (props: Props) => (
    <Svg {...props} viewBox="0 0 14 20">
      <path d="M4 19c0 .5.5 1 1 1h4c.5 0 1-.5 1-1v-1H4v1zM7 0C3.1 0 0 3.1 0 7c0 2.4 1.2 4.5 3 5.7V15c0 .5.5 1 1 1h6c.5 0 1-.5 1-1v-2.3c1.8-1.3 3-3.4 3-5.7 0-3.9-3.1-7-7-7zm2.8 11.1l-.8.6V14H5v-2.3l-.8-.6C2.8 10.2 2 8.6 2 7c0-2.8 2.2-5 5-5s5 2.2 5 5c0 1.6-.8 3.2-2.2 4.1z" />
    </Svg>
  ),
  'idea-filled': (props: Props) => (
    <Svg {...props} viewBox="0 0 14 20">
      <path d="M4 19c0 .5.5 1 1 1h4c.5 0 1-.5 1-1v-1H4v1zM7 0C3.1 0 0 3.1 0 7c0 2.4 1.2 4.5 3 5.7V15c0 .5.5 1 1 1h6c.5 0 1-.5 1-1v-2.3c1.8-1.3 3-3.4 3-5.7 0-3.9-3.1-7-7-7z" />
    </Svg>
  ),
  idea2: (props: Props) => (
    <Svg
  ...
  search: (props: Props) => (
    <Svg {...props} viewBox="0 0 17.5 17.5">
  ...
  azureactivedirectory: (props: Props) => (
  ...
  notification_mention: (props: Props) => (
    <Svg {...props} viewBox="0 0 17 17">
      <path
        fill="#6B6B6B"
        fillRule="nonzero"
  ...
  saveAlt: (props: Props) => (
    <Svg {...props} viewBox="0 0 18 18">
      <path d="M-3-3h24v24H-3z" fill="none" />
      <path d="M16 9v7H2V9H0v7c0 1.1.9 2 2 2h14a2 2 0 002-2V9zm-6 .7L12.6 7 14 8.5l-5 5-5-5 1.4-1.4L8 9.7V0h2z" />
    </Svg>
  ),
  map: (props: Props) => (
    <Svg {...props} viewBox="0 0 18 18">
      <path d="M-3-3h24v24H-3z" fill="none" />
      <path d="M17.5 0h-.2L12 2.1 6 0 .4 1.9c-.2 0-.4.2-.4.5v15.1c0 .3.2.5.5.5h.2L6 15.9l6 2.1 5.6-1.9c.2 0 .4-.3.4-.5V.5c0-.3-.2-.5-.5-.5zM12 16l-6-2.1V2l6 2.1z" />
    </Svg>
  ),
  mapCenter: (props: Props) => (
    <Svg {...props} viewBox="0 0 22 22">
      <path d="M-1-1h24v24H-1z" fill="none" />
      <path d="M11 7a4 4 0 100 8 4 4 0 000-8zm9 3a9 9 0 00-8-8V0h-2v2a9 9 0 00-8 8H0v2h2a9 9 0 008 8v2h2v-2a9 9 0 008-8h2v-2zm-9 8a7 7 0 110-14 7 7 0 010 14z" />
    </Svg>
  ),
  mapmarker: (props: Props) => (
  ...
  notification_invitation_accepted: (props: Props) => (
  ...
  notification_status: (props: Props) => (
  ...
  arrowLeft: (props: Props) => (
    <MirrorOnRtlSvg {...props} width="16" height="12" viewBox="0 0 16 12">
  ...
  questionMarkRoundedOutlined: (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 20 20"
  ...
  share: (props: Props) => (
    <Svg {...props} viewBox="0 0 18 15">
      <path d="M18 7l-7-7v4C4 5 1 10 0 15c2.5-3.5 6-5.1 11-5.1V14l7-7z" />
    </Svg>
  ),
  play: (props: Props) => (
    <Svg
  ...
  lightningBolt: (props: Props) => (
    <Svg {...props} viewBox="0 0 10 20">
      <path fill="none" d="M-7-2h24v24H-7V-2z" />
      <path d="M10 0H0v11h3v9l7-12H6z" />
    </Svg>
  ),
  database: (props: Props) => (
    <Svg {...props} viewBox="0 0 25 30">
      <path d="M24.6 22c-.3-.1-.5-.1-.6 0-2.5 1.9-6.8 3-11.5 3s-9-1.1-11.5-3c-.3-.1-.5-.1-.6 0-.3.1-.4.4-.4.5v1.9C0 27.5 5.5 30 12.5 30S25 27.5 25 24.4v-1.9c0-.2-.1-.5-.4-.5z" />
      <ellipse cx="12.5" cy="5.6" rx="12.5" ry="5.6" />
      <path d="M24.6 15.6c-.3-.1-.5-.1-.6 0-2.5 1.9-6.8 3-11.5 3s-9-1.1-11.5-3c-.3-.1-.5-.1-.6 0-.3.2-.4.4-.4.5V18c0 3.1 5.5 5.6 12.5 5.6S25 21.1 25 18v-1.9c0-.1-.1-.3-.4-.5z" />
      <path d="M24.6 9.4c-.3-.1-.5-.1-.6 0-2.5 1.9-6.8 3-11.5 3s-9-1.1-11.5-3c-.3-.1-.5-.1-.6 0-.3.1-.4.4-.4.5v1.9c0 3.1 5.5 5.6 12.5 5.6S25 14.9 25 11.8V9.9c0-.1-.1-.4-.4-.5z" />
    </Svg>
  ),
  menu: (props: Props) => (
    <Svg
    ...
    >
      <g className="menu-icon">
        <path className="menu-1-icon" d="M0 14H4.70846V0H0V14Z" />
        <path
  ...
  userExport: (props: Props) => (
    ...
    >
      <g className="User-Export-icon">
        ...
        />
        <g className="cl-icon-accent Database-user-icon">
          <path
  ...
  initiativesAdminMenuIcon: (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      width="26"
  ...
  'folder-add': (props: Props) => (
    ...
    >
      ...
      <path d="M18 2h-8L8 0H2C.89 0 .01.89.01 2L0 14c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V4c0-1.11-.89-2-2-2zm-1 8h-3v3h-2v-3H9V8h3V5h2v3h3z" />
    </Svg>
  ),
  moderation: (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 45 45"
  ...
  'clock-solid': (props: Props) => (
    <Svg {...props} viewBox="0 0 15 15">
      <path d="M7.5 0C3.375 0 0 3.375 0 7.5S3.375 15 7.5 15 15 11.625 15 7.5 11.625 0 7.5 0zM4.275 10.125L3.75 9.15l3-1.725V3.75h1.125V8.1l-3.6 2.025z" />
    </Svg>
  ),
  bullseye: (props: Props) => (
  ...
  list2: (props: Props) => (
    <Svg {...props} viewBox="0 0 20 12">
      <path d="M-2-5.5h24v24H-2z" fill="none" />
      <path d="M0 10v2h20v-2zm0-5v2h20V5zm0-5v2h20V0z" />
    </Svg>
  ),
  link: (props: Props) => (
  ...
  participationLevel: (props: Props) => (
  ...
  'file-add': (props: Props) => (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.25 0A2.25 2.25 0 000 2.25v13.5A2.25 2.25 0 002.25 18h9a2.25 2.25 0 002.25-2.25V6.09a2.25 2.25 0 00-.66-1.59L9 .66A2.25 2.25 0 007.41 0zm5.625 6.75a1.125 1.125 0 00-2.25 0V9h-2.25a1.125 1.125 0 000 2.25h2.25v2.25a1.125 1.125 0 002.25 0v-2.25h2.25a1.125 1.125 0 100-2.25h-2.25z"
      />
    </Svg>
  ),
  simpleFolder: (props: Props) => (
  ...
  flag: (props: Props) => (
    <Svg {...props} viewBox="0 0 15 17">
      <path d="M9.4 2L9 0H0v17h2v-7h5.6l.4 2h7V2H9.4z" />
    </Svg>
  ),
  finish_flag: (props: Props) => (
    <Svg {...props} viewBox="0 0 15 17">
      <path d="M9.4 2H15v10H8l-.4-2H2v7H0V0h9l.4 2M9 10h2V8h2V6h-2V4H9v2L8 4V2H6v2H4V2H2v2h2v2H2v2h2V6h2v2h2V6l1 2v2M6 6V4h2v2H6m3 0h2v2H9z" />
    </Svg>
  ),
  person: (props: Props) => (
    <Svg {...props} viewBox="0 0 16 16">
      <circle cx="8" cy="4" r="4" />
      <path d="M8 10c-2.7 0-8 1.3-8 4v2h16v-2c0-2.7-5.3-4-8-4z" />
    </Svg>
  ),
  event: (props: Props) => (
  ...
  'basket-plus': (props: Props) => (
    <Svg {...props} viewBox="0 0 24 24">
      <path d="M20 15v3h3v2h-3v3h-2v-3h-3v-2h3v-3h2m3-5v.3l-1 3.5a6 6 0 00-8.7 7.2H5.5a2 2 0 01-1.8-1.1l-2.6-9.5L1 10c0-.6.4-1 1-1h4.6l4.6-6.6a1 1 0 011.6 0L17.4 9H22c.6 0 1 .4 1 1m-9 5a2 2 0 10-4 0 2 2 0 004 0m1-6l-3-4.3L9 9h6z" />
    </Svg>
  ),
  'basket-minus': (props: Props) => (
    <Svg {...props} viewBox="0 0 24 24">
      <path d="M23 18v2h-8v-2h8m0-8v.3l-1 3.5a6 6 0 00-8.7 7.2H5.5a2 2 0 01-1.8-1.1l-2.6-9.5L1 10c0-.6.4-1 1-1h4.6l4.6-6.6a1 1 0 011.6 0L17.4 9H22c.6 0 1 .4 1 1m-9 5a2 2 0 10-4 0 2 2 0 004 0m1-6l-3-4.3L9 9h6z" />
    </Svg>
  ),
  'basket-checkmark': (props: Props) => (
  ...
  'citizenlab-footer-logo': (props: Props) => (
  ...
  'circle-arrow-left': (props: Props) => (
    <MirrorOnRtlSvg {...props} width="26" height="26" viewBox="0 0 26 26">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M26 13a13 13 0 11-26 0 13 13 0 0126 0zm-12.425 4.3a.814.814 0 01-1.15 1.15L7.55 13.575a.813.813 0 010-1.15l4.875-4.875a.814.814 0 011.15 1.15l-3.489 3.488h7.789a.812.812 0 110 1.624h-7.789l3.49 3.488z"
      />
    </MirrorOnRtlSvg>
  ),
  'share-arrow': (props: Props) => (
    <Svg {...props} width="20" height="17" viewBox="0 0 20 17">
      <path d="M12.167 4.75V.417L19.75 8l-7.583 7.583v-4.441c-5.417 0-9.209 1.733-11.917 5.525C1.333 11.25 4.583 5.833 12.167 4.75z" />
    </Svg>
  ),
  ...
  'exclamation-trapezium-strikethrough': (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 32 32"
    >
      <path d="M12.1 5.1h8.67l6.12 6.13v8.67l-.33.33 2.12 2.1 1.2-1.2V10L22 2.12H10.86l-1.2 1.2 2.11 2.12.33-.33zM16.43 23.04a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
      <path d="M17.93 11.58V8.1h-3v.49l3 2.99zM2.1 0L0 2.1l5.44 5.44L2.99 10v11.15L10.86 29h11.15l2.45-2.45L29.89 32 32 29.9 2.1 0zm18.66 26.02H12.1L5.98 19.9v-8.67l1.56-1.56 14.8 14.79-1.57 1.56z" />
    </Svg>
  ),
  'exclamation-trapezium': (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 25 25"
    >
      <path d="M17.68 0H7.32L0 7.32v10.36L7.32 25h10.36L25 17.68V7.32L17.68 0zm4.54 16.53l-5.7 5.7H8.48l-5.7-5.7V8.47l5.7-5.7h8.06l5.7 5.7v8.06z" />
      <path d="M12.5 19.44a1.39 1.39 0 100-2.77 1.39 1.39 0 000 2.77zM11.11 5.55h2.78v9.73H11.1V5.55z" />
    </Svg>
  ),
  'eyeOpened-unfilled': (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 29 20"
    >
      <path d="M14.5 2.67c2.42-.01 4.8.67 6.86 1.97A12.98 12.98 0 0126.13 10a12.85 12.85 0 01-11.63 7.33c-5 0-9.45-2.84-11.63-7.33a12.98 12.98 0 014.77-5.36 12.77 12.77 0 016.86-1.97zm0-2.67A15.6 15.6 0 000 10a15.6 15.6 0 0014.5 10A15.6 15.6 0 0029 10 15.6 15.6 0 0014.5 0zm0 6.67c.87 0 1.71.35 2.33.97a3.35 3.35 0 01-2.33 5.7c-.87 0-1.71-.36-2.33-.98a3.35 3.35 0 012.33-5.7zm0-2.67a5.98 5.98 0 00-5.93 6c0 3.3 2.66 6 5.93 6 3.27 0 5.93-2.7 5.93-6s-2.66-6-5.93-6z" />
    </Svg>
  ),
  'eyeClosed-unfilled': (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 30 27"
    >
      <path d="M15 5a13 13 0 017.1 2.1 13.63 13.63 0 014.93 5.66 13.55 13.55 0 01-3.29 4.4l1.92 1.99c1.9-1.74 3.4-3.9 4.34-6.39A16.15 16.15 0 0015 2.19c-1.73 0-3.4.28-4.96.8l2.25 2.33C13.17 5.13 14.07 5 15 5zm-1.46 1.61l2.82 2.92c.78.35 1.4 1 1.75 1.8l2.82 2.92A6.22 6.22 0 0015 6.41c-.5 0-.98.08-1.46.2zM1.38 2.01l3.65 3.77A16.52 16.52 0 000 12.76a16.15 16.15 0 0015 10.57c2.07 0 4.06-.4 5.9-1.15L25.54 27l1.93-1.99L3.3 0 1.38 2zM11.6 12.57l3.56 3.68a.66.66 0 01-.16.02c-.9 0-1.77-.37-2.41-1.03-.64-.66-1-1.56-1-2.49l.01-.18zm-4.63-4.8l2.38 2.47a6.68 6.68 0 00.25 5.51 6.02 6.02 0 007.81 2.83l1.34 1.39c-1.2.34-2.45.53-3.75.53a13 13 0 01-7.1-2.08 13.63 13.63 0 01-4.93-5.67 13.86 13.86 0 014-4.98z" />
    </Svg>
  ),
  'filter-funnel': (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 12 12"
    >
      <path d="M.159 1.208A5414.53 5414.53 0 014.47 6.75v4.5c0 .412.338.75.75.75h1.5c.413 0 .75-.338.75-.75v-4.5s2.79-3.6 4.305-5.543A.748.748 0 0011.184 0H.75A.748.748 0 00.16 1.208z" />
    </Svg>
  ),
  ...
  tokens: (props: Props) => (
    <Svg
      ...
      viewBox="0 0 19 19"
    >
      <path d="M9.5 0C4.78 0 0 1.376 0 4.006c0 2.63 4.78 4.006 9.5 4.006 4.722 0 9.5-1.376 9.5-4.006C19 1.376 14.222 0 9.5 0zM4.75 8.848v2.67c1.175.267 2.475.43 3.8.482V9.33a21.381 21.381 0 01-3.8-.482zm5.7.48V12a21.212 21.212 0 003.8-.482v-2.67c-1.247.274-2.52.435-3.8.481zm5.7-1.051v2.67C17.861 10.277 19 9.295 19 8.013v-2.67c0 1.282-1.139 2.263-2.85 2.935zm-13.3 2.67v-2.67C1.14 7.605 0 6.623 0 5.342v2.67c0 1.282 1.14 2.263 2.85 2.936z" />
    </Svg>
  ),
  'coin-stack': (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 20 20"
    >
      <g clipPath="url(#clip0)" fill="#5C6A79">
  ...
  'circled-star': (props: Props) => (
    <Svg
      {...props}
      className={`cl-icon ${props.className ? props.className : ''}`}
      viewBox="0 0 16 16"
    >
      <path d="M8 0a8 8 0 100 16A8 8 0 008 0zm.053 2.799l1.26 3.936 4.132.093-3.354 2.414 1.188 3.96-3.333-2.445L4.55 13.11l1.295-3.925-3.29-2.504 4.134.018L8.053 2.8z" />
    </Svg>
  ),
};
...
const Icon: FC<Props> = memo<Props>((props) => {
  const propsWithTheme = { ...props, colorTheme: colors };
